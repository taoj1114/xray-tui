...
fn render_tab_bar(f: &mut Frame, area: Rect, app: &App) {
    ...
    let cur = match &app.current_screen { Screen::Dashboard=>0, Screen::InboundList|Screen::ConfigPicker{..}=>1, Screen::RoutingEditor{..}=>2, Screen::SslManagement{..}=>3, Screen::LogViewer(_)=>4, Screen::Settings(_)=>5, _=>0 };
